  ...
  return (
    <div className="mt-20 px-4 sm:px-10">
      <h2 className="text-3xl sm:text-5xl lg:text-6xl text-center mt-6 tracking-wide">
        ...
        <span className="bg-gradient-to-r from-blue-700 via-red-800 to-orange-500 text-transparent bg-clip-text"> {" "} Vitalos</span>
      </h2>
      <div className="flex flex-col lg:flex-row justify-center lg:justify-between items-center lg:items-stretch gap-8 mt-12">
        ...
        <div className="w-full lg:w-1/2 px-4 flex flex-col justify-center">
          ...
          <h3 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-blue-700 via-red-800 to-orange-500 mb-6">
          ...
          {champTextImage[currentIndex].bulletPoints.map((point, index) => (
            <div key={index} className="flex items-center gap-4 mb-6">
              <div className="flex-shrink-0 text-white-400 bg-neutral-900 h-10 w-10 flex justify-center items-center rounded-full">
